        ...
        return [
            SidebarSection(
                ...
                items: [
                    ...
                    SidebarItem(id: "controleur", label: "Controleur", icon: "gamecontroller", level: .atelier),
                ]
            ),
            SidebarSection(
                id: "orchestre",
                level: .orchestre,
                items: [
                    SidebarItem(id: "niveaux",     label: "Ecrans",      icon: "square.grid.3x3.fill", level: .orchestre),
                ]
            ),
            ...
            SidebarSection(
                ...
                level: .hardware,
                items: [
                    SidebarItem(id: "cartouche",    label: "Cartouche",    icon: "cpu",             level: .hardware),
                    SidebarItem(id: "registres",    label: "Registres",    icon: "list.clipboard",  level: .hardware),
                    SidebarItem(id: "memoire",      label: "Memoire",      icon: "memorychip",      level: .hardware),
                    SidebarItem(id: "vram",         label: "VRAM",         icon: "photo.artframe",  level: .hardware),
                    SidebarItem(id: "couches_bg",   label: "Couches BG",   icon: "square.3.layers.3d", level: .hardware),
