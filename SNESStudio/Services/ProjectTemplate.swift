...
enum ProjectTemplate: String, CaseIterable, Identifiable {
    ...
    var label: String {
        ...
        case .sprite: return String(localized: "Sprite Demo")
        }
    }

    var description: String {
        switch self {
        case .basic:  return String(localized: "Screen with background color, main loop")
        case .sprite: return String(localized: "Animated sprite with controller movement")
        }
    }
    ...
    private func generateMain(config: CartridgeConfig) -> String {
        ...
        ; Cartridge: \(config.mapping.rawValue) \(config.romSizeKB) KB
        ; ============================================
    ...
    private func generateHeader(config: CartridgeConfig) -> String {
        ...
        ; SNES ROM Header
        ; Generated by SNES Studio
        ; Mapping: \(config.mapping.rawValue), \(config.romSizeKB) KB ROM
        ; ============================================
    ...
    private func generateSaveRoutines(config: CartridgeConfig) -> String {
        ...
        ; Generated by SNES Studio
        ; SRAM: \(config.sramSizeKB) KB @ \(sramAddr)
        ; ============================================
